...
#do a randomForest
set.seed(2)
rf=randomForest(y=meta[train],x=(geneExpr[train,]),mtry=(sqrt(ncol(geneExpr))),importance=TRUE,ntree=1000,nodesize=20) 
...
performanceRF
importance(rf)
pdf("/Users/robjelier/Projects/Courses/LM&GLM/2022/Lecture_2-3/varImpPlotRF.pdf")
varImpPlot (rf)
dev.off()
#do a bagged tree
...
performanceBag
pdf("/Users/robjelier/Projects/Courses/LM&GLM/2022/Lecture_2-3/varImpPlotBag.pdf")
varImpPlot(bag)
dev.off()
